...
void _GLOBAL__I_global_state();

void _GLOBAL__I_left_joystick();
...
void (*_ctors[])() =
    {
    _GLOBAL__I_global_state,
    _GLOBAL__I_left_joystick,
...
void _GLOBAL__D_global_state();

void _GLOBAL__D_left_joystick();
...
void (*_dtors[])() =
    {
    _GLOBAL__D_global_state,
    _GLOBAL__D_left_joystick,
